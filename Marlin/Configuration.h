...
#define STRING_CONFIG_H_AUTHOR "(abegg)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //PURPLE BED
  #define  DEFAULT_bedKp 216.73
  #define  DEFAULT_bedKi 14.00
  #define  DEFAULT_bedKd 838.89
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.81, 79.90, 405.50, 712 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 0.00  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 0.00  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.63   // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION   // Enable G26 mesh validation
    ...
    #define MESH_TEST_BED_TEMP       95.00   // (°C) Default bed temperature for the G26 Mesh Validation Tool.
  #endif
  ...
  #define LEFT_PROBE_BED_POSITION 4
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (50*55)
